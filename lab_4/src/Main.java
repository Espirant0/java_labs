...
public class Main {
    public static void main(String[] args) {
        ...
        while(game) {
            ...
            if (board.shahCheck('b')) {
                System.out.println("Шах для черных фигур.");
                if (board.mat()) {
                    System.out.println("Мат для черных фигур.");
                    System.out.println("Игра завершена. Победили белые.");
                    in.close();
                    break;
                }
            }

            if (board.shahCheck('w')) {
                System.out.println("Шах для белых фигур.");
                if (board.mat()) {
                    System.out.println("Мат для белых белых фигур.");
                    System.out.println("Игра завершена. Победили чёрные.");
                    in.close();
                    break;
                }
            }
